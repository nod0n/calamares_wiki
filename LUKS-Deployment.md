...
* Calamares 2.3 or later (depending on your initramfs generator, a more recent version may be required, see the detailed instructions);
...
* an initramfs management solution, like `mkinitcpio` (see the detailed instructions for a list of currently supported ones);
